...
# abstract semi-base for defining predictors with common
# labeling methods, weight vector methods, etc. Saves us
# some code that would otherwise be copied for first
# for assignments in every class
class Predictor_Weight(Predictor):
    __metaclass__ = ABCMeta
